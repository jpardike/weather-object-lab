...
Access the city information using some kind of object notation.
...
function getCity(obj) {
    return `The coordinates of ${obj.city.name} are ${obj.city.coord.lat} latitude and ${obj.city.coord.lon} longitude.`;
}
...
Write logic to console.log the weather description for 3-20 at 6pm. Make the output a nice English sentence.

*/

console.log(evanstonWeather.list[29].dt_txt);

function weather3206pm(obj) {
    return `The weather on March 20th at 6pm for ${obj.city.name} was ${obj.list[31].weather[0].description}.`
}

console.log(weather3206pm(evanstonWeather));

/* 

Write logic to print out the forecasted temperature for 3-20 at 9am. Make the output a nice English sentence, and code any conversion necessary (Temp is given in Kelvin)

*/

console.log(`The forecasted temperature in ${evanstonWeather.city.name} on March 20th ant 9am was ${evanstonWeather.list[29].main.temp} degrees Kelvin.`)

/* 

Write logic to find wind speed and direction on St. Patrick's day at 3pm. Do some googling to figure out how to convert meters/second to mph, and how to convert the meteorological description of wind direction into human-understandable format. Write logic to do the conversions (don't just plug 3m/s in mph into Google or some other online converter). When you get it all figured out, you will use all of it to console.log a sentence that reads "The wind will be blowing (some cardinal direction that you will figure out--N, NE, E, SE, S, SW, W, NW are the choices) at (whatever mph you calculated from the given m/s). There is a pretty substantial amount of research and calculation required to do this, plus thinking outside the box.
